							...
							<div class="col-sm-9">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-4" style="padding: 5px;">
										<b class="lisSub">Subject : &nbsp;<? echo $subject; ?></b>
									</div>

									<div class="col-sm-4" style="padding: 5px;">
										<i class="lisYr">Semester : &nbsp;<? echo $year; ?></i>
									</div>


									<div class="col-sm-4" style="padding: 5px;">
										<i class="lisProf">Professor : &nbsp;<? echo $prof; ?></i>
									</div>
								...
								<div class="row">
								    <div class="col-sm-4" style="padding: 5px;">
										<i class="lisClassLVL" style="padding: 5px;">Class Lvl : &nbsp;<? echo $classLVL; ?></i>
									</div>
									
									<div class="col-sm-4" style="padding: 5px;">
										<i class="lisCategory" style="padding: 5px;">Category : &nbsp;<? echo $category; ?></i>
									</div>
									
									<!--<div class="col-sm-4" style="padding: 5px;">-->
									<!--	<i class="lisUni" style="padding: 5px;">University : &nbsp;<? //echo $university; ?></i>-->
									<!--</div>-->
								</div>
								...
								<div class="row" style="margin-top: 20px; margin-bottom: 20px;">
									...
									<div class="col-sm-10" style="padding: 5px;">
										<p class="lisDesc">Description : &nbsp;<? echo $desc; ?></p>
									</div>
