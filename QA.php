...
?>
    ...
    <body>
			...
			<ul class="list" style="padding-bottom: 20px; margin-top: 10px;">
                ...
                <div class="row QARow">
                    ...
                    <div class="col-sm-9 quesDetails">
                        ...
                        <div class="row">
                            <div class="col-sm-12 quesClass"><? echo $ques; ?></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 descClass"><? echo $desc; ?></div>
                        </div>
                        
                        <br>
                        
                        <div class="row">
                            <div class="col-sm-9">Class Name :- <? echo $className; ?></div>
                            <div class="col-sm-3"><a href = "QDetails.php?id=<? echo $id ?>" class="viewBtn">View / Answer</a></div>
                        </div>
        ...
        <script>
            ...
            myListOBJ.sort('masId', { order: "desc" }); // Sorts the list in zxy-order based on names
