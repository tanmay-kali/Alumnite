<?php
	session_start();
	// $_SESSION['MainAdminLoggedIn'] = "false";
?>
<!DOCTYPE html>
<html>
	<head>
			...
			<ul class="list" style="padding: 0; margin: 0; width: 100%; padding-bottom: 20px;">
				<div class="row" style="margin-bottom: 20px;">
					...
					<?php
						...
						$result= mysqli_query($conn, $sql) or die("SELECT Error: ".mysql_error());
					...
					?>
	 					...
	 					<div class="row" style="margin-top:15px;">
							<div class="col-sm-1 masId" style="border-right: 1px solid #E5E5E5;"><? echo $id; ?></div>
							<div class="col-sm-1 masName" style="border-right: 1px solid #E5E5E5;"><? echo $name; ?></div>
							<div class="col-sm-1 masSub" style="border-right: 1px solid #E5E5E5;"><? echo $subject; ?></div>
							<div class="col-sm-1 masProf" style="border-right: 1px solid #E5E5E5;"><? echo $prof; ?></div>
							<div class="col-sm-2 masUpldBy" style="border-right: 1px solid #E5E5E5; word-wrap: break-word;"><? echo $upldBy; ?></div>
                            <div class="col-sm-1 masUni text-center" style="border-right: 1px solid #E5E5E5;"><? echo $uni; ?></div>
                            
							<form action="/action_page.php" class="col-sm-2 text-center">
								<div class="form-check-inline">
									<label class="form-check-label" for="radio1">
										<input type="radio" class="form-check-input" id="pRadY" name="pendingRadio" value="Yes" checked onchange="pChange('Yes','<? echo $id; ?>');" 
										<? if ($pending == "Yes") { echo "checked"; }?>
										>Yes
									</label>
								</div>
								<div class="form-check-inline">
									<label class="form-check-label" for="radio2">
										<input type="radio" class="form-check-input" id="pRadN" name="pendingRadio" value="No" onchange="pChange('No','<? echo $id; ?>');"
										<? if ($pending == "No") { echo "checked"; }?>
										>No
									</label>
								</div>
  							</form>
							...
							<button class="col-sm-1 masViewDoc" onclick="window.open('<? echo $docPath; ?>','_blank');">View Doc</button>
							<button class="col-sm-1 masDeleteDoc" onclick="deleteDoc('<? echo $id; ?>','<? echo $docPath; ?>')">Delete Doc</button>
						</div>
						<hr>
			...
			<ul class="list" style="padding: 0; margin: 0; width: 100%; padding-bottom: 20px;">
				<div class="row" style="margin-bottom: 20px;">
					...
					?>
	 					<!-- this html code is in the while loop whih means it will run everytime -->
	 					<div class="row" style="margin-top:15px;">
							<div class="col-sm-1 usId" style="border-right: 1px solid #E5E5E5;"><? echo $id; ?></div>
							<div class="col-sm-1 usName" style="border-right: 1px solid #E5E5E5;"><? echo $name; ?></div>
							<div class="col-sm-2 usEmail" style="border-right: 1px solid #E5E5E5; word-wrap: break-word;"><? echo $email; ?></div>
							<div class="col-sm-1 usMajor" style="border-right: 1px solid #E5E5E5;"><? echo $major; ?></div>
							<div class="col-sm-1 usGrad" style="border-right: 1px solid #E5E5E5;"><? echo $gradDate; ?></div>
                            <div class="col-sm-2 usPhone text-center" style="border-right: 1px solid #E5E5E5;"><? echo $phone; ?></div>
                            <div class="col-sm-2 usUni text-center" style="border-right: 1px solid #E5E5E5;"><? echo $uni; ?></div>
                            
                            <input type="text" class="col-sm-2 usCoins text-center" value=" <? echo $coins; ?>" id="coinInputMas<? echo $id; ?>" onchange="updateCoin(<? echo $id; ?>);" />
