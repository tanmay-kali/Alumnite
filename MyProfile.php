		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center" style="margin-top: 10px; margin-bottom: -5px;">
				<span class="col-sm-3" id="myCoinBtn">
					My Coins : <? echo $table_coins; ?> <i class="fas fa-coins"></i>
				</span>
			</div>
				...
				<div class="col-sm-12" style="padding: 20px; padding-top: 0px;" >
					<form id="UpdateInfoForm" method='POST'>
						...
						<div class="MyProfGroup input-group" style="padding-top: 0;">
	                        ...
	                        <input type="text" class="form-control" name="myProfName" id="myProfName" placeholder="Your Name" value="<? echo $table_name; ?>" required/>
	                    </div>

	                    <div class="MyProfGroup input-group">
	                        <label for="myProfEmail" class="input-group-addon"><i class="fas fa-envelope"></i></label>
	                        <input type="text" class="form-control" name="myProfEmail" id="myProfEmail" placeholder="Your Email" value="<? echo $table_email; ?>" required/>
	                    </div>

	                    <div class="MyProfGroup input-group">
	                        <label for="myProfMajor" class="input-group-addon"><i class="fas fa-graduation-cap"></i></label>
	                        <input type="text" class="form-control" name="myProfMajor" id="myProfMajor" placeholder="Your Major" value="<? echo $table_Major; ?>" required/>
	                    </div>

	                    <div class="MyProfGroup input-group">
	                        <label for="myProfGrad" class="input-group-addon"><i class="fas fa-calendar"></i></label>
	                        <input type="text" class="form-control" name="myProfGrad" id="myProfGrad" placeholder="Your Graduation Date" value="<? echo $table_GradDate; ?>" required/>
	                    </div>

	                    <div class="MyProfGroup input-group">
	                        <label for="myProfPhone" class="input-group-addon"><i class="fas fa-phone"></i></label>
	                        <input type="text" class="form-control" name="myProfPhone" id="myProfPhone" placeholder="Your Phone No." value="<? echo $table_PhoneNo; ?>" required/>
	                    </div>
	                    ...
	                    <div class="input-group mb-3" style="height: 100%; margin:0; margin-bottom: 0px; margin-top: 12px;">
    						...
    						<select class="custom-select" id="myProfUni" name="myProfUni">
    							...
    							<option value="Texas Christian University" <? if($_SESSION['Uni'] == "Texas Christian University"){ echo "selected"; } ?> >Texas Christian University </option>
    							
    							<option value="Baylor University" <? if($_SESSION['Uni'] == "Baylor University"){ echo "selected"; } ?> >Baylor University</option>
    							
    							<option value="SMU" <? if($_SESSION['Uni'] == "SMU"){ echo "selected"; } ?> >SMU</option>
    						</select>
    					</div>
